<div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <x-jet-nav-link href="{{ route('admin.menus.deleted') }}" :active="request()->routeIs('admin.menus.deleted')">
    ...
    <x-jet-nav-link href="{{ route('admin.menus.deactivated') }}" :active="request()->routeIs('admin.menus.deactivated')">
    ...
    <x-jet-nav-link  href="{{ route('admin.menus') }}" :active="request()->routeIs('admin.menus')">
    ...
    @if(! str_contains(url()->current(), 'deactivated') && ! str_contains(url()->current(), 'deleted'))
        <livewire:core::admin.menus.create-menu-item-button value="New Menu" :params="['item' => false]" />
        <livewire:core::admin.menus.create-menu-item-button value="New Item" :params="['item' => true]" />
    @endif
</div>
