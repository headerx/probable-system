<x-core::admin.users.livewire-tables.table>
    <x-slot name="head">
        @if (count($bulkActions))
            <x-core::admin.users.livewire-tables.table.heading>
    ...
    <x-slot name="body">
        @include('admin.users.livewire-tables.tailwind.includes.bulk-select-row')

        @forelse ($rows as $index => $row)
            <x-core::admin.users.livewire-tables.table.row
        ...
        @empty
            <x-core::admin.users.livewire-tables.table.row>
                <x-core::admin.users.livewire-tables.table.cell :colspan="count($bulkActions) ? count($columns) + 1 : count($columns)">
